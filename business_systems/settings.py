...
HR_BASE_URL = os.getenv('HR_BASE_URL', BASE_URL)
EXTERNAL_JOBS_BASE_URL = os.getenv('EXTERNAL_JOBS_BASE_URL', BASE_URL)
EMPLOYEE_SYSTEM_BASE_URL = os.getenv('EMPLOYEE_SYSTEM_BASE_URL', BASE_URL)
